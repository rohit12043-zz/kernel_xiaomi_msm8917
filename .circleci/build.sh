...
git clone --depth=1 https://github.com/rohit12043/kernel_xiaomi_msm8917 kernel
cd kernel
...
function sticker() {
    curl -s -X POST "https://api.telegram.org/bot$token/sendSticker" \
        -d sticker="CAACAgEAAxkBAAIDiF-tDoi42vjPPWscv4bCDvzdnkxfAAKYAQACRV8HL0qKdgqvH5YAAR4E" \
        -d chat_id=$chat_id
}
